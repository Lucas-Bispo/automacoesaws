...
def find_active_vpc_regions(session):
    ...
    verificando por VPCs customizadas ou recursos na VPC padrão.
    """
    ...
    for region_name in all_regions:
        ...
        try:
            ...
            # Verifica se existem VPCs que não são a padrão
    ...
    while True:
        ...
        if choice in REPORTS:
            ...
            try:
                ...
                # 2. Executa o pipeline de ponta a ponta em memória e gera o relatório final
            ...
            break # Encerra após a execução. Remova esta linha se quiser que o menu reapareça.
        else:
            print("\nOpção inválida!")
