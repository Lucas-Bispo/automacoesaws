...
def collect_data(regions_to_scan: list):
    ...
    de um recurso por linha (formato sumarizado). Os dados complexos como
    regras e tags são mantidos em seu formato original (lista de dicionários).
    """
    ...
    # Converte as listas de dicionários brutos em DataFrames do Pandas
...
def collect_and_save_as_json(output_path: str, regions_to_scan: list):
    ...
    Retorna os DataFrames para uso nas próximas etapas.
    """
    ...
    # Retorna os DataFrames para o pipeline do main.py
